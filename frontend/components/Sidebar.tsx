...
// Importing types from our API service to maintain DRY architecture
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-1.5 custom-scrollbar">
          {sessions.length === 0 ? (
            <div className="text-center text-gray-500 text-sm mt-10 flex flex-col items-center gap-2">
              ...
              <span>No chat history yet.<br/>Start a conversation!</span>
            </div>
          ) : (
            sessions.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[11px] text-gray-500 truncate flex items-center gap-1.5">
                    {/* Date and Time Formatting (en-US for global standard) */}
                    {new Date(item.created_at).toLocaleDateString("en-US", { hour: "2-digit", minute: "2-digit", day: "numeric", month:"short" })}
                  </div>
